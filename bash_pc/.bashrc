unset TMOUT  # disable automatic logout
...
# commands for nrgljubljana
source /opt/intel/parallel_studio_xe_2020.2.108/psxevars.sh
export MKL_DYNAMIC=FALSE
export MKL_NUM_THREADS=8
#export OMP_MAX_ACTIVE_LEVELS=TRUE
export OMP_NUM_THREADS=4

PATH=~/bin/:~/Kodeak/wannier90-3.1.0/utility/:~/Kodeak/wannier90-3.1.0:$HOME/nrg/bin:~/Kodeak/xcrysden-1.5.60-bin-semishared:~/Kodeak/qe-6.6/bin:$PATH
PATH=/usr/local/bin:$PATH
PATH=/home/aitor/Kodeak/julia-1.10.0/bin:$PATH
...
alias loginasier='ssh -Y acalvo@u110575.lc.ehu.es'
alias loginfermi='ssh -Y acalvo@u111389.lc.ehu.es'

alias terminalcolor='bash -c  "$(wget -qO- https://git.io/vQgMr)"'
